...
namespace ReportService.Core
{
    public class GenerateHtmlEmail
    {
        public string GenerateErrors(List<Error> errors, int interval)
        {
            ...
            html += @"</table><br /><br /><i>Automatyczna wiadomość wysłana z aplikacji
                ReportServices.</i>";
        ...
        public string GenerateReport(Report report)
        {
            ...
            var html = $@"Raport {report.Title} 
                 z dnia {report.Date.ToString("dd-MM-yyy")}.<br /><br />";
            ...
            if(report.Positions.Any() && report.Positions != null)
            {
                ...
                html += @"<br /><br /><i>Automatyczna wiadomość wysłana z aplikacji
                ReportServices.</i>";
